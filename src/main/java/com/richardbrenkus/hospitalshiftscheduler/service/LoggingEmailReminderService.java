...
public class LoggingEmailReminderService
    ...
    public void sendShiftRequestReminderEmail(String recipientEmail, String recipientDisplayName, LocalDate finalSubmissionDate, String idempotencyKey) {
        ...
        log.info("Reminder email would be sent to {}. " + "Recipient name = {}, deadline = {}, " + "idempotency key = {}", recipientEmail.trim(), normalizeDisplayName(recipientDisplayName), finalSubmissionDate, idempotencyKey.trim());
    }
    ...
    private void validateArguments(String recipientEmail, LocalDate finalSubmissionDate, String idempotencyKey) {
        ...
        if (finalSubmissionDate == null) {
            throw new IllegalArgumentException("finalSubmissionDate must not be null");
        }
    ...
    private String normalizeDisplayName(String recipientDisplayName) {
