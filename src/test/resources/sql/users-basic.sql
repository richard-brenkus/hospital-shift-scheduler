...
VALUES (2001, 'Admin Root', 'admin.root', 'admin@example.test', '$2a$10$7EqJtq98hPqEX7fNZaFWoOhiY6Pz/5N4qpx3vP.f4LyOmdx4Mq2Fy', 'Test admin', '2026-07-01 08:00:00', '1970-01-01', 'Doctor', 'MUDr.', TRUE, 'ADMIN', 0, NULL);

INSERT INTO users (user_id, name, username, email, password, note, creation_date, birthday, profession, title, enabled, role, version, shift_request_id)
VALUES (2002, 'Alice Doe', 'alice.doe', 'alice@example.test', '$2a$10$7EqJtq98hPqEX7fNZaFWoOhiY6Pz/5N4qpx3vP.f4LyOmdx4Mq2Fy', 'Test user 1', '2026-07-02 09:00:00', '1990-05-05', 'Doctor', '', TRUE, 'USER', 0, NULL);
...
INSERT INTO users (user_id, name, username, email, password, note, creation_date, birthday, profession, title, enabled, role, version, shift_request_id)
VALUES (2003, 'Bob Smith', 'bob.smith', 'bob@example.test', '$2a$10$7EqJtq98hPqEX7fNZaFWoOhiY6Pz/5N4qpx3vP.f4LyOmdx4Mq2Fy', 'Test user 2', '2026-07-03 09:00:00', '1988-06-06', 'psychiatrist', 'Bc.', TRUE, 'USER', 0, NULL);
