...
VALUES (3001, 'Freddie Mercury', 'freddie.mercury', 'freddie@example.test', '$2a$10$7EqJtq98hPqEX7fNZaFWoOhiY6Pz/5N4qpx3vP.f4LyOmdx4Mq2Fy', 'Fixture user', '2026-07-04 10:00:00', '1967-01-24', 'psychiatrist', 'MUDr.', TRUE, 'USER', 3001);
...
INSERT INTO users (user_id, name, username, email, password, note, creation_date, birthday, profession, title, enabled, role, shift_request_id)
VALUES (3002, 'Mick Jagger', 'mick.jagger', 'mick@example.test', '$2a$10$7EqJtq98hPqEX7fNZaFWoOhiY6Pz/5N4qpx3vP.f4LyOmdx4Mq2Fy', 'Fixture user without request', '2026-07-05 09:00:00', '1987-06-09', 'psychiatrist', 'Bc.', TRUE, 'USER', NULL);
