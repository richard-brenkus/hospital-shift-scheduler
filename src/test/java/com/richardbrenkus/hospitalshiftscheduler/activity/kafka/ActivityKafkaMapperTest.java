...
class ActivityKafkaMapperTest {
    ...
    void toMessage_shouldNotEmbedJpaEntitiesOrRuntimeEnumTypes() {
        ...
        assertThat(message).extracting(ActivityKafkaMessage::eventId, ActivityKafkaMessage::occurredAt, ActivityKafkaMessage::activityType, ActivityKafkaMessage::actorRole).allSatisfy(value -> assertThat(value.getClass().getPackageName()).doesNotStartWith("com.richardbrenkus.hospitalshiftscheduler"));
    }
