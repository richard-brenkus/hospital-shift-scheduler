...
class ScheduleRuleServiceIT extends AbstractMySqlContainerTest {
    ...
    void shouldLoadPreviousMonthDaysIndexedByBackwardOffset_whenGapCoversMonthBoundary() {
        ...
        Map<Integer, StoredScheduleDay> previous = scheduleRuleService.loadPreviousStoredScheduleDays(firstOfAugust, 2);
        ...
        assertThat(previous.get(0).getAssignmentsByShiftType()).containsKey(2);
        assertThat(previous.get(-1).getAssignmentsByShiftType()).containsKey(1);
    }
    ...
    void shouldReturnEmptyMap_whenNoPreviousDaysExistForRequestedGap() {
        ...
        Map<Integer, StoredScheduleDay> previous = scheduleRuleService.loadPreviousStoredScheduleDays(LocalDate.of(2020, 1, 1), 3);
